        ...
        <div class="container container-class" data-aos="fade-up"> 
            <div class="rounded p-5 shadow bg-white" data-aos="zoom-in">
                <div class="col-lg-8">
                    ...
                    <form method="POST" action="/dashboard/bootcampcategory/{{ $bootcampcategory->id }}">
                        @csrf
                        @method('put')
                        <div class="mb-3">
                          <label for="name_category" class="form-label">Name Category</label>
                          <input type="text" class="form-control @error('name_category') is-invalid @enderror" id="name_category" name="name_category" required autofocus value="{{ old('name_category', $bootcampcategory->name_category) }}">
                          @error('name_category')
